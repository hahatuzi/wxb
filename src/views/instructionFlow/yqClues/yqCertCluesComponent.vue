    ...
    export default {
        ...
        methods:{
            handleCurrentChange(val){
                ...
                this.query();
                this.startNum = this.yqCertCluesList.length > 0? ((this.currentPage -1)* this.pageSize +1):0;
                this.endNum = this.yqCertCluesList.length > 0 ?(this.startNum + this.yqCertCluesList.length -1):0;
            },
            ...
            info(row){
              ...
              this.$router.push({path:'/instructionFlow/yqCertClueInfo',query:{operateType:'1',id:row.infoid}});
            },
            addInfo(){
                this.$router.push({path:'/instructionFlow/yqCertClueInfo',query:{operateType:'0'}});
            },
            modify(row){
                this.$router.push({path:'/instructionFlow/yqCertClueInfo',query:{operateType:'2',id:row.infoid}});
            },
            sousuo(){
                this.currentPage = 1;
                this.query();
            ...
            query(){
                ...
                getList(url, yqgzTdinfo).then(result =>{
                    this.loading = false;
                    this.yqCertCluesList = result.rows;
